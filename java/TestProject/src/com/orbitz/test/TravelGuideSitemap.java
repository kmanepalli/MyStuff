...
public class TravelGuideSitemap {

    public List <String> getIds(int i) throws Exception {
        List <String> ids = new ArrayList <String>();

        SolrServer hotServer = new CommonsHttpSolrServer("http://indexedsearch.prod.o.com:8980/location");
    ...
    public static void main(String p[]) throws Exception {
    	PrintWriter writer = new PrintWriter( "/users/mkchakravarti/flights/hotel_dynamo_city_ebuk.txt" );  
    	TravelGuideSitemap map = new TravelGuideSitemap();
        //for(int i=8;i<11;i++){
        List <String> ids = map.getIds(1);
        System.out.println("fetched Ids"+ids.size());
        List <String> canons = new ArrayList <String>();
        for (String id : ids) {
            String url = "http://egcmsref01.prod.o.com:10000/deals/module/redirect/EBUK/en_GB/301//hotels/.hd"+id;
            try {
                URL u = new URL(url);
                String line = null;
